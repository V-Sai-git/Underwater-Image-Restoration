...
def load_images(hazy_folder, clean_folder):
    ...
    for filename in os.listdir(hazy_folder):
        ...
        if os.path.isfile(hazy_path) and os.path.isfile(clean_path):
            ...
            # Check for null or None objects
...
# Load data
hazy_folder = "/Users/saijayaamruth/PycharmProjects/BDAEndsem4/DLSIPendsem/LSUI/input"
clean_folder = "/Users/saijayaamruth/PycharmProjects/BDAEndsem4/DLSIPendsem/LSUI/GT"
...
# Train the model
history = model.fit(train_hazy, train_clean, validation_data=(test_hazy, test_clean), epochs=1, batch_size=40)
